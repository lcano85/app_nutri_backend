...
exports.PatientsModule = PatientsModule = __decorate([
    (0, common_1.Module)({ controllers: [patients_controller_1.PatientsController], providers: [patients_service_1.PatientsService, permissions_guard_1.PermissionsGuard] })
], PatientsModule);
